    ...
    <section id="course-details" class="course-details">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <p style="text-align: justify">La gimnasia moderna tiene su origen pedagógico en 1811, cuando Friedrich Ludwig Jahn, profesor del Instituto Alemán de Berlín, creó un primer espacio para la práctica de gimnasia artística al aire libre. Gran parte de los actuales aparatos derivan de sus diseños.</p>
          </div>
          <div class="col-lg-4">
